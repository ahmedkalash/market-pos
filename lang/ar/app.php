...
return [
    ...
    'attributes' => 'الخصائص',
    'attributes_helper' => 'حدد الخصائص المنطبقة على هذا المنتج (مثال: اللون، المقاس).',
    'value' => 'القيمة',
    ...
    'category_helper' => 'اختر فئة لتصنيف هذا المنتج (مثال: مشروبات، إلكترونيات).',
    'tax_class_helper' => 'اختر فئة الضريبة التي تنطبق على هذا المنتج.',
    'uom_helper' => 'الوحدة المستخدمة للبيع والمخزون (مثال: قطعة، كيلوغرام).',
    'attribute_helper' => 'نوع الخاصية (مثال: اللون).',
    'attribute_value_item_helper' => 'القيمة المحددة لهذه الخاصية (مثال: أحمر).',
