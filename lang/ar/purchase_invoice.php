...
return [
    ...
    'unit_cost_tooltip' => 'تكلفة الشراء للوحدة. يتم تحديث السعر الأخير للمنتج عند الاعتماد.',
    'line_total_tooltip' => 'يتم حسابه تلقائياً: الكمية × تكلفة الوحدة.',
    'notes_tooltip' => 'اختياري: ملاحظات خاصة بهذا البند (مثل رقم التشغيلة، الصلاحية).',
