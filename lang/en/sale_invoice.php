...
return [
    ...
    'subtotal_amount_helper' => 'The gross sum of all items before any item-level or invoice-level discounts are applied.',
    'grand_total_discount' => 'Grand Total Discount',
    'grand_total_discount_helper' => 'The total savings across the entire invoice (combines all individual item discounts PLUS the global invoice discount).',
    'total_amount_helper' => 'The final payable amount by the customer after all discounts have been applied.',
