...
return [
    ...
    'attributes_helper' => 'Select the attributes that apply to this product (e.g. Color, Size).',
    'value' => 'Value',
    ...
    'tax_classes_description' => 'Define the tax rates that can be applied to products in this company.',
    'rate' => 'Rate',
    ...
    'category_helper' => 'Select a category to group this product (e.g., Beverages, Electronics).',
    'tax_class_helper' => 'Select the tax rate that applies to this product.',
    'uom_helper' => 'The unit used for selling and stock (e.g., Piece, Kilogram).',
    'attribute_helper' => 'The type of property (e.g., Color).',
    'attribute_value_item_helper' => 'The specific value for this property (e.g., Red).',
